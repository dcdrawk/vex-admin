...
<script>
  ...
  import VDataTable from '../vex/DataTable.vue';
  import VSearchBar from '../vex/Searchbar.vue'
    ...
    data () {
      return {
        ...
        dropdownMarkup: `<!-- Basic Dropdown -->
                ...
                <v-icon-button v-el:button2 icon="more_vert" @click="open2 = !open2"></v-icon-button>
