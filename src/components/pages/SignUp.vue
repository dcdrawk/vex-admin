        ...
        <form autocomplete="off">
          <div class="row">
            <div class="col-xs-12 col-md-12">
              <v-input label="Email" type="email" :value="email" @input="email = $event" autocomplete="false"></v-input>
            </div>
            <div class="col-xs-12 col-md-12">
              <v-input label="Password" type="password" :value="password" @input="password = $event" autocomplete="new-password"></v-input>
            </div>
          </div>
          <div slot="actions">
